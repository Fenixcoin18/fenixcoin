...
unsigned int nStakeMinAge = 30 * 60 * 60; // 30 hours as zero time weight
unsigned int nStakeMaxAge = 90 * 60 * 60; // 90 hours as full weight
...
// miner's coin base reward premine -- Premined: 400.000.000
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fenixcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "fenixcoin.com Block";
        CTransaction txNew;
        txNew.nTime = 1525743328;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525743328;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2320094;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x76b23a7e93df402c4e45c307ebf9162da5cd23f52b5753c66cc3a32afbd1f783"));
        block.print();
